...
const latestArticles = [
  { title: "Drag us to Singapore? Over our dead bodies", category: "Public Affairs", date: "December 20, 2025" },
  { title: "Health certificates are great, but can the chef really cook?", category: "Kenyan Life", date: "December 14, 2025" },
  { title: "Rude culture shock awaits our triumphant warriors from Haiti", category: "Public Affairs", date: "December 14, 2025" },
  { title: "President’s Award-Kenya is a gem that shouldn’t be dissolved", category: "People & Society", date: "December 2025" },
];
          ...
          <div className={styles.latestList}>
            {latestArticles.map((article) => (
              <article key={article.title}>
                ...
                <h3><Link href="/archive">{article.title}</Link></h3>
              </article>
            ))}
          </div>
        </section>
